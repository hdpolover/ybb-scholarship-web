                    ...
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="<?= base_url('auth/reset_password_aksi') ?>" class="needs-validation" novalidate="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="email" class="form-control" name="email" tabindex="1" value="<?= $email; ?>" required readonly>
