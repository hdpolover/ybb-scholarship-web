...
<div class="docs-page-header">
	<div class="row align-items-center">
		<div class="col-sm">
			<h1 class="docs-page-header-title">Announcement
				<button type="button" class="btn btn-primary btn-sm float-end" data-bs-toggle="modal"
					data-bs-target="#add">Add New Announcement</button>
			</h1>
			<p class="docs-page-header-text">Manage announcement information in here.</p>
		</div>
	</div>
</div>
<!-- End Page Header -->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?= site_url('admin/addAnnouncement');?>" method="post">
					...
					<div class="mb-3">
						<label class="input-label mb-2"> Choose what will this announcement will be delivered to <small
								class="text-danger">*</small></label>
						<div class="row">
					...
					<div class="modal-footer px-0 pb-0">
						...
						<button type="submit" class="btn btn-info btn-sm">Post announcement</button>
					</div>
				</form>
			</div>
		</div>
